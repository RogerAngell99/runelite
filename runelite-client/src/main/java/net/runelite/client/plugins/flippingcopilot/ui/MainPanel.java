...
import net.runelite.client.plugins.flippingcopilot.controller.CopilotLoginController;
import net.runelite.client.plugins.flippingcopilot.model.LoginResponseManager;
