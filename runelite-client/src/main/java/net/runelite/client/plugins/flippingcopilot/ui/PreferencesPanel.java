...
import net.runelite.client.plugins.flippingcopilot.controller.PremiumInstanceController;
import net.runelite.client.plugins.flippingcopilot.model.SuggestionPreferencesManager;
import net.runelite.client.plugins.flippingcopilot.model.SuggestionManager;
